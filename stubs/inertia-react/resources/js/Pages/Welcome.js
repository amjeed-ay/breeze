                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div className="p-6 border-t border-gray-200 dark:border-gray-700">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4 text-lg leading-7 font-semibold">
                                        <a
                                            href="https://laravel-news.com/" target="_blank"
                                            className="underline text-gray-900 dark:text-white"
                                        >
                                            Laravel News
                                        </a>
                            ...
                            <div className="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                                ...
                                <div className="ml-12">
                                    <div className="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        ...
                                        <a href="https://forge.laravel.com" target="_blank" className="underline">
                                            Forge
                                        </a>
                                        ,{' '}
                                        <a href="https://vapor.laravel.com" target="_blank" className="underline">
                                            Vapor
                                        </a>
                                        ,{' '}
                                        <a href="https://nova.laravel.com" target="_blank" className="underline">
                                            Nova
                                        </a>
                                        , and{' '}
                                        <a href="https://envoyer.io" target="_blank" className="underline">
                                            Envoyer
                                        </a>{' '}
                                        help you take your projects to the next level. Pair them with powerful open
                                        source libraries like{' '}
                                        <a href="https://laravel.com/docs/billing" target="_blank" className="underline">
                                            Cashier
                                        </a>
                                        ,{' '}
                                        <a href="https://laravel.com/docs/dusk" target="_blank" className="underline">
                                            Dusk
                                        </a>
                                        ,{' '}
                                        <a href="https://laravel.com/docs/broadcasting" target="_blank" className="underline">
                                            Echo
                                        </a>
                                        ,{' '}
                                        <a href="https://laravel.com/docs/horizon" target="_blank" className="underline">
                                            Horizon
                                        </a>
                                        ,{' '}
                                        <a href="https://laravel.com/docs/sanctum" target="_blank" className="underline">
                                            Sanctum
                                        </a>
                                        ,{' '}
                                        <a href="https://laravel.com/docs/telescope" target="_blank" className="underline">
                                            Telescope
                                        </a>
                                        , and more.
                                    </div>
                    ...
                    <div className="flex justify-center mt-4 sm:items-center sm:justify-between">
                        <div className="text-center text-sm text-gray-500 sm:text-left">
                            <div className="flex items-center">
                                ...
                                <a href="https://laravel.bigcartel.com" target="_blank" className="ml-1 underline">
                                    Shop
                                </a>
                                ...
                                <a href="https://github.com/sponsors/taylorotwell" target="_blank" className="ml-1 underline">
                                    Sponsor
                                </a>
                            </div>
                        </div>
